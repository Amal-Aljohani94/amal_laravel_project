    ...
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center">
        ...
        <ul class="dropdown-menu ">
            <li><a class="dropdown-item text-center" href="{{url('language/ar')}}">العربية   <img src="images/arabic.png" class="rounded-circle" width="30" height="30"  alt="">  </a></li>
            <li><a class="dropdown-item text-center" href="{{url('language/en')}}">English <img src="images/en.png" class="rounded-circle" width="30" height="30"  alt=""> </a></li>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="{{route('product-details')}}" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Product Details</span></a>
                        </li>
                        <li>
